...
print(
    "What do you want to do? Encrypt (Type in text to be decrypted by a friend) or Decrypt (Decrypt text, or have the computer decrypt offsetted text you want")
...
# for each letter findedthe index
...
# U VWXY Z A BCDE F GHIJKLMNOPQRST
